...
\section{Datapath}
\subsection{Descrição}
\paragraph A decisão mais relevante na datapath foi a codificação de sinal utilizada nos registos e na Unidade Lógico-Aritmética.
\paragraph De modo a compreender intuitivamente os valores em uso, os displays devem mostrar os valores com uma codificação sinal-módulo. Assim, e uma vez que os valores dos displays originam nos registos da Datapath, decidimos que todo o armazenamento de valores deve ser feito em formato sinal-módulo.
\paragraph Esta decisão reflectiu-se não só nos formatos dos registos como também na ULA em si.
\subsection{Registos}
